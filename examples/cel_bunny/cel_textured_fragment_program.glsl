...
// Cel-shading sobre un modelo con mapa difuso. Es el mismo shader de
// cel_fragment_program: la diferencia está marcada donde aparece la textura.
...
vec3 cel_light(vec3 base_color, vec3 normal, vec3 view_direction,
               vec3 light_position, vec3 light_color)
{
    ...
    vec3 diffuse = base_color * light_color * diffuse_quantized;
...
void main()
{
    ...
    vec3 light_2 = cel_light(base_color, normal, view_direction, light_2_position, light_2_color);
